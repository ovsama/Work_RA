...
def generate_file_structure():
    ...
    folder_name = f"{today}-Var CMC-{brand_name} {ccr_ro} {variation_title}-{country}-Dispatch{dispatch_number}"
...
labels = ["Brand Name:", "CCR-RO:", "Variation Title:", "Country:", "Dispatch Number:"]
entries = []
