...
input_label = tk.Label(root, text="Enter amount in EUR:", font=bold_font)
...
convert_button = tk.Button(root, text="Convert", command=convert, font=bold_font)
convert_button.grid(row=0, column=2, padx=10, pady=10)

# Create label for displaying result
result_text = tk.Text(root, height=2, width=40, wrap="word", state="disabled", font=bold_font)
